...
var getCurrentLocationOrCity = function (req, res) {
    if (req === void 0) { req = express_1.request; }
    if (res === void 0) { res = express_1.response; }
    return __awaiter(void 0, void 0, void 0, function () {
...
exports.getCurrentLocationOrCity = getCurrentLocationOrCity;
var getForecastCurrentLocationOrCity = function (req, res) {
    if (req === void 0) { req = express_1.request; }
    if (res === void 0) { res = express_1.response; }
    return __awaiter(void 0, void 0, void 0, function () {
